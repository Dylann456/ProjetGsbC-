...
namespace Antibio.Models
{
    class DataAntibio
    {
        ...
        //            //unAntibioParKilo = new AntibioParKilo("Gentamicine", "mg", uneCategorie1, 1, 6);
        //            //DataAntibio.lesAntibiotiques.Add(unAntibioParKilo);
        //            //unAntibioParKilo = new AntibioParKilo("Nitromicine", "mg", uneCategorie1, 1, 6);
        //            //DataAntibio.lesAntibiotiques.Add(unAntibioParKilo);
        //            //unAntibioParKilo = new AntibioParKilo("Tobramyc1ine", "mg", uneCategorie1, 1, 6);
        //            //DataAntibio.lesAntibiotiques.Add(unAntibioParKilo);

        //            //AntibioParPrise unAntibioParPrise;
        //            //unAntibioParPrise = new AntibioParPrise("Flucanazole", "mg", uneCategorie2, 300, 1);
        //            //DataAntibio.lesAntibiotiques.Add(unAntibioParPrise);
        //            //unAntibioParPrise = new AntibioParPrise("Itraconazole", "mg", uneCategorie2, 200, 1);
        //            //DataAntibio.lesAntibiotiques.Add(unAntibioParPrise);
